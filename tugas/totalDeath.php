...
$query = mysqli_query($conn,"select country, totDeath from covid");
while ($row = mysqli_fetch_assoc($query)) {
    $country[] = $row['country'];
    $totDeath[] = $row['totDeath'];
}
?>
            ...
            <script>
              ...
              var myChart = new Chart(ctx, {
                ...
                data: {
                  ...
                  datasets: [{
                    label: 'Grafik angka kematian akibat Covid-19 pada 10 negara Asia',
                    data: <?php echo json_encode($totDeath); ?>,
                    borderWidth: 1
                  }]
                },
                options: {
              ...
              var pieConfig = {
                ...
                data: {
                  datasets: [{
                    ...
                    label: 'Presentase angka kematian akibat Covid-19 pada 10 negara Asia'
                  }],
                  labels: <?php echo json_encode($country); ?>
                },
                options: {

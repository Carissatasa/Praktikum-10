...
$query = mysqli_query($conn,"select country, activeCase from covid");
            ...
            <script>
              ...
              var myChart = new Chart(ctx, {
                ...
                data: {
                  ...
                  datasets: [{
                    label: 'Grafik angka penderita Covid-19 aktif pada 10 negara Asia',
                    data: <?php echo json_encode($activeCase); ?>,
                    borderWidth: 1
                  }]
                },
                options: {
              ...
              var pieConfig = {
                ...
                data: {
                  datasets: [{
                    ...
                    label: 'Presentase angka penderita Covid-19 aktif pada 10 negara Asia'
                  }],
                  labels: <?php echo json_encode($country); ?>
                },
                options: {

...
$query = mysqli_query($conn,"select country, totTest from covid");
            ...
            <script>
              ...
              var myChart = new Chart(ctx, {
                ...
                data: {
                  ...
                  datasets: [{
                    label: 'Grafik angka test Covid-19 pada 10 negara Asia',
                    data: <?php echo json_encode($totTest); ?>,
                    borderWidth: 1
                  }]
                },
                options: {
              ...
              var pieConfig = {
                ...
                data: {
                  datasets: [{
                    ...
                    label: 'Presentase angka test Covid-19 pada 10 negara Asia'
                  }],
                  labels: <?php echo json_encode($country); ?>
                },
                options: {
